  ...
  return (
    <main className="pt-24">
      <section className="px-6 py-24 lg:px-12">
        <span className="mb-1 block text-xs text-orange-400">03</span>
        ...
        <p className="mt-20 max-w-xl border-t border-border pt-8 text-sm leading-relaxed text-foreground/70">
          ...
          primarily C++ backend and infrastructure roles. Most of what
          I&apos;ve shipped is full-stack, so I&apos;m comfortable there too.
        </p>
      </section>
    </main>
  );
